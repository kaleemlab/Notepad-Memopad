...
export const Banner = () => {
    ...
    const toRotate = ["Manager", "Developer", "Designer", "Entrepreneur"];
    const period = 1000;
                        ...
                        <TrackVisibility>
                            {({isVisible}) =>
                                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                                    <span className="tagline">Manager - Developer - Designer - Entrepreneur</span>
                                    <h1>{`I'm Raja Kaleem.`}</h1>
                                    ...
                                    <p>Digital Product Manager And Director, Specialized in MVP Design and
                                        Development.</p>
